    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('erp_type', models.CharField(choices=[('odoo', 'Odoo')], default='odoo', max_length=50)),
                ('industry', models.CharField(choices=[('manufacturing', 'Manufacturing'), ('retail', 'Retail'), ('logistics', 'Logistics'), ('healthcare', 'Healthcare'), ('finance', 'Finance'), ('other', 'Other')], max_length=100)),
